namespace _07_ByteBank
{
    public class ContaCorrente
    {
        ...
        private double _saldo = 100.0; // convenção, colocamos o _ pois é privado e pertence somente a essa classe

        public double Saldo // convenção de nomeação de propriedades
        {
            get
            {
                return _saldo; 
